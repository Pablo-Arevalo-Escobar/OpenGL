...
void Shader::setMat4(const std::string& name, glm::mat4 transMatrix) const
{
    glUniformMatrix4fv((glGetUniformLocation(ID, name.c_str())), 1,GL_FALSE,glm::value_ptr(transMatrix));
